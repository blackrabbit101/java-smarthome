 ...
 * @author Alex Norman norman1@uab.edu
 */
public class bedroom extends lights {
     ...
     */
    public bedroom(String title) {
        super(); //we call our parent function that handles all of our consturction. 

        UID = "(" + UIDcount + ")";

        ComponentTitle = "Bedroom Room light number " + ComponentNumber; // we essentially save the number and title here in our component title when its genrated then increment
