 ...
 * @author Alex Norman norman1@uab.edu
 */
public class Kitchen extends lights {
    ...
    public Kitchen(String title) {
        ...
        ComponentTitle = "Kitchen Room light number " + ComponentNumber; // we essentially save the number and title here in our component title when its genrated then increment
     ...
     */
    public void changeColor(lights.ColorType change) {
        if (change == ColorType.WHITE || change == ColorType.YELLOW) {
            Color = change;
        } else {
            System.out.print("It's tacky to have a colored kitchen");
        }
    }
}
